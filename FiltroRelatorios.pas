...
begin
    senhaDigitada := InputBox('Atenção',#31+'Insira a senha para confirmar a exclusão:','');
    ...
    begin
       ...
       log := 'Danfe '+ DanfeRelatorio.Text + ' Excluído em '+ dataAtual +' '+ horaAtual + ' pelo usuário '+ usuario;
       dm.tb_log.Insert;
    ...
    begin
        MessageBox(Handle,'Senha Inválida, contacte o administrador do sistema.', 'Atenção', MB_OK);
    end;
end;
